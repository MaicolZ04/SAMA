(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function n(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=n(r);fetch(r.href,s)}})();var ge={update:null,begin:null,loopBegin:null,changeBegin:null,change:null,changeComplete:null,loopComplete:null,complete:null,loop:1,direction:"normal",autoplay:!0,timelineOffset:0},G={duration:1e3,delay:0,endDelay:0,easing:"easeOutElastic(1, .5)",round:0},Be=["translateX","translateY","translateZ","rotate","rotateX","rotateY","rotateZ","scale","scaleX","scaleY","scaleZ","skew","skewX","skewY","perspective","matrix","matrix3d"],R={CSS:{},springs:{}};function P(e,t,n){return Math.min(Math.max(e,t),n)}function V(e,t){return e.indexOf(t)>-1}function Z(e,t){return e.apply(null,t)}var f={arr:function(e){return Array.isArray(e)},obj:function(e){return V(Object.prototype.toString.call(e),"Object")},pth:function(e){return f.obj(e)&&e.hasOwnProperty("totalLength")},svg:function(e){return e instanceof SVGElement},inp:function(e){return e instanceof HTMLInputElement},dom:function(e){return e.nodeType||f.svg(e)},str:function(e){return typeof e=="string"},fnc:function(e){return typeof e=="function"},und:function(e){return typeof e>"u"},nil:function(e){return f.und(e)||e===null},hex:function(e){return/(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(e)},rgb:function(e){return/^rgb/.test(e)},hsl:function(e){return/^hsl/.test(e)},col:function(e){return f.hex(e)||f.rgb(e)||f.hsl(e)},key:function(e){return!ge.hasOwnProperty(e)&&!G.hasOwnProperty(e)&&e!=="targets"&&e!=="keyframes"}};function he(e){var t=/\(([^)]+)\)/.exec(e);return t?t[1].split(",").map(function(n){return parseFloat(n)}):[]}function ye(e,t){var n=he(e),i=P(f.und(n[0])?1:n[0],.1,100),r=P(f.und(n[1])?100:n[1],.1,100),s=P(f.und(n[2])?10:n[2],.1,100),c=P(f.und(n[3])?0:n[3],.1,100),o=Math.sqrt(r/i),a=s/(2*Math.sqrt(r*i)),v=a<1?o*Math.sqrt(1-a*a):0,l=1,d=a<1?(a*o+-c)/v:-c+o;function g(h){var u=t?t*h/1e3:h;return a<1?u=Math.exp(-u*a*o)*(l*Math.cos(v*u)+d*Math.sin(v*u)):u=(l+d*u)*Math.exp(-u*o),h===0||h===1?h:1-u}function w(){var h=R.springs[e];if(h)return h;for(var u=1/6,y=0,x=0;;)if(y+=u,g(y)===1){if(x++,x>=16)break}else x=0;var m=y*u*1e3;return R.springs[e]=m,m}return t?g:w}function qe(e){return e===void 0&&(e=10),function(t){return Math.ceil(P(t,1e-6,1)*e)*(1/e)}}var Fe=function(){var e=11,t=1/(e-1);function n(l,d){return 1-3*d+3*l}function i(l,d){return 3*d-6*l}function r(l){return 3*l}function s(l,d,g){return((n(d,g)*l+i(d,g))*l+r(d))*l}function c(l,d,g){return 3*n(d,g)*l*l+2*i(d,g)*l+r(d)}function o(l,d,g,w,h){var u,y,x=0;do y=d+(g-d)/2,u=s(y,w,h)-l,u>0?g=y:d=y;while(Math.abs(u)>1e-7&&++x<10);return y}function a(l,d,g,w){for(var h=0;h<4;++h){var u=c(d,g,w);if(u===0)return d;var y=s(d,g,w)-l;d-=y/u}return d}function v(l,d,g,w){if(!(0<=l&&l<=1&&0<=g&&g<=1))return;var h=new Float32Array(e);if(l!==d||g!==w)for(var u=0;u<e;++u)h[u]=s(u*t,l,g);function y(x){for(var m=0,p=1,E=e-1;p!==E&&h[p]<=x;++p)m+=t;--p;var I=(x-h[p])/(h[p+1]-h[p]),S=m+I*t,k=c(S,l,g);return k>=.001?a(x,S,l,g):k===0?S:o(x,m,m+t,l,g)}return function(x){return l===d&&g===w||x===0||x===1?x:s(y(x),d,w)}}return v}(),be=function(){var e={linear:function(){return function(i){return i}}},t={Sine:function(){return function(i){return 1-Math.cos(i*Math.PI/2)}},Expo:function(){return function(i){return i?Math.pow(2,10*i-10):0}},Circ:function(){return function(i){return 1-Math.sqrt(1-i*i)}},Back:function(){return function(i){return i*i*(3*i-2)}},Bounce:function(){return function(i){for(var r,s=4;i<((r=Math.pow(2,--s))-1)/11;);return 1/Math.pow(4,3-s)-7.5625*Math.pow((r*3-2)/22-i,2)}},Elastic:function(i,r){i===void 0&&(i=1),r===void 0&&(r=.5);var s=P(i,1,10),c=P(r,.1,2);return function(o){return o===0||o===1?o:-s*Math.pow(2,10*(o-1))*Math.sin((o-1-c/(Math.PI*2)*Math.asin(1/s))*(Math.PI*2)/c)}}},n=["Quad","Cubic","Quart","Quint"];return n.forEach(function(i,r){t[i]=function(){return function(s){return Math.pow(s,r+2)}}}),Object.keys(t).forEach(function(i){var r=t[i];e["easeIn"+i]=r,e["easeOut"+i]=function(s,c){return function(o){return 1-r(s,c)(1-o)}},e["easeInOut"+i]=function(s,c){return function(o){return o<.5?r(s,c)(o*2)/2:1-r(s,c)(o*-2+2)/2}},e["easeOutIn"+i]=function(s,c){return function(o){return o<.5?(1-r(s,c)(1-o*2))/2:(r(s,c)(o*2-1)+1)/2}}}),e}();function K(e,t){if(f.fnc(e))return e;var n=e.split("(")[0],i=be[n],r=he(e);switch(n){case"spring":return ye(e,t);case"cubicBezier":return Z(Fe,r);case"steps":return Z(qe,r);default:return Z(i,r)}}function xe(e){try{var t=document.querySelectorAll(e);return t}catch{return}}function N(e,t){for(var n=e.length,i=arguments.length>=2?arguments[1]:void 0,r=[],s=0;s<n;s++)if(s in e){var c=e[s];t.call(i,c,s,e)&&r.push(c)}return r}function $(e){return e.reduce(function(t,n){return t.concat(f.arr(n)?$(n):n)},[])}function ue(e){return f.arr(e)?e:(f.str(e)&&(e=xe(e)||e),e instanceof NodeList||e instanceof HTMLCollection?[].slice.call(e):[e])}function X(e,t){return e.some(function(n){return n===t})}function ee(e){var t={};for(var n in e)t[n]=e[n];return t}function Q(e,t){var n=ee(e);for(var i in e)n[i]=t.hasOwnProperty(i)?t[i]:e[i];return n}function U(e,t){var n=ee(e);for(var i in t)n[i]=f.und(e[i])?t[i]:e[i];return n}function je(e){var t=/rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(e);return t?"rgba("+t[1]+",1)":e}function Ve(e){var t=/^#?([a-f\d])([a-f\d])([a-f\d])$/i,n=e.replace(t,function(o,a,v,l){return a+a+v+v+l+l}),i=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(n),r=parseInt(i[1],16),s=parseInt(i[2],16),c=parseInt(i[3],16);return"rgba("+r+","+s+","+c+",1)"}function He(e){var t=/hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(e)||/hsla\((\d+),\s*([\d.]+)%,\s*([\d.]+)%,\s*([\d.]+)\)/g.exec(e),n=parseInt(t[1],10)/360,i=parseInt(t[2],10)/100,r=parseInt(t[3],10)/100,s=t[4]||1;function c(g,w,h){return h<0&&(h+=1),h>1&&(h-=1),h<1/6?g+(w-g)*6*h:h<1/2?w:h<2/3?g+(w-g)*(2/3-h)*6:g}var o,a,v;if(i==0)o=a=v=r;else{var l=r<.5?r*(1+i):r+i-r*i,d=2*r-l;o=c(d,l,n+1/3),a=c(d,l,n),v=c(d,l,n-1/3)}return"rgba("+o*255+","+a*255+","+v*255+","+s+")"}function Re(e){if(f.rgb(e))return je(e);if(f.hex(e))return Ve(e);if(f.hsl(e))return He(e)}function A(e){var t=/[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?(%|px|pt|em|rem|in|cm|mm|ex|ch|pc|vw|vh|vmin|vmax|deg|rad|turn)?$/.exec(e);if(t)return t[1]}function Ne(e){if(V(e,"translate")||e==="perspective")return"px";if(V(e,"rotate")||V(e,"skew"))return"deg"}function J(e,t){return f.fnc(e)?e(t.target,t.id,t.total):e}function T(e,t){return e.getAttribute(t)}function te(e,t,n){var i=A(t);if(X([n,"deg","rad","turn"],i))return t;var r=R.CSS[t+n];if(!f.und(r))return r;var s=100,c=document.createElement(e.tagName),o=e.parentNode&&e.parentNode!==document?e.parentNode:document.body;o.appendChild(c),c.style.position="absolute",c.style.width=s+n;var a=s/c.offsetWidth;o.removeChild(c);var v=a*parseFloat(t);return R.CSS[t+n]=v,v}function we(e,t,n){if(t in e.style){var i=t.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase(),r=e.style[t]||getComputedStyle(e).getPropertyValue(i)||"0";return n?te(e,r,n):r}}function ae(e,t){if(f.dom(e)&&!f.inp(e)&&(!f.nil(T(e,t))||f.svg(e)&&e[t]))return"attribute";if(f.dom(e)&&X(Be,t))return"transform";if(f.dom(e)&&t!=="transform"&&we(e,t))return"css";if(e[t]!=null)return"object"}function Se(e){if(f.dom(e)){for(var t=e.style.transform||"",n=/(\w+)\(([^)]*)\)/g,i=new Map,r;r=n.exec(t);)i.set(r[1],r[2]);return i}}function $e(e,t,n,i){var r=V(t,"scale")?1:0+Ne(t),s=Se(e).get(t)||r;return n&&(n.transforms.list.set(t,s),n.transforms.last=t),i?te(e,s,i):s}function re(e,t,n,i){switch(ae(e,t)){case"transform":return $e(e,t,i,n);case"css":return we(e,t,n);case"attribute":return T(e,t);default:return e[t]||0}}function ne(e,t){var n=/^(\*=|\+=|-=)/.exec(e);if(!n)return e;var i=A(e)||0,r=parseFloat(t),s=parseFloat(e.replace(n[0],""));switch(n[0][0]){case"+":return r+s+i;case"-":return r-s+i;case"*":return r*s+i}}function Le(e,t){if(f.col(e))return Re(e);if(/\s/g.test(e))return e;var n=A(e),i=n?e.substr(0,e.length-n.length):e;return t?i+t:i}function ie(e,t){return Math.sqrt(Math.pow(t.x-e.x,2)+Math.pow(t.y-e.y,2))}function Ue(e){return Math.PI*2*T(e,"r")}function Ye(e){return T(e,"width")*2+T(e,"height")*2}function We(e){return ie({x:T(e,"x1"),y:T(e,"y1")},{x:T(e,"x2"),y:T(e,"y2")})}function Ee(e){for(var t=e.points,n=0,i,r=0;r<t.numberOfItems;r++){var s=t.getItem(r);r>0&&(n+=ie(i,s)),i=s}return n}function _e(e){var t=e.points;return Ee(e)+ie(t.getItem(t.numberOfItems-1),t.getItem(0))}function Me(e){if(e.getTotalLength)return e.getTotalLength();switch(e.tagName.toLowerCase()){case"circle":return Ue(e);case"rect":return Ye(e);case"line":return We(e);case"polyline":return Ee(e);case"polygon":return _e(e)}}function Ze(e){var t=Me(e);return e.setAttribute("stroke-dasharray",t),t}function Qe(e){for(var t=e.parentNode;f.svg(t)&&f.svg(t.parentNode);)t=t.parentNode;return t}function Ce(e,t){var n=t||{},i=n.el||Qe(e),r=i.getBoundingClientRect(),s=T(i,"viewBox"),c=r.width,o=r.height,a=n.viewBox||(s?s.split(" "):[0,0,c,o]);return{el:i,viewBox:a,x:a[0]/1,y:a[1]/1,w:c,h:o,vW:a[2],vH:a[3]}}function Je(e,t){var n=f.str(e)?xe(e)[0]:e,i=t||100;return function(r){return{property:r,el:n,svg:Ce(n),totalLength:Me(n)*(i/100)}}}function Ge(e,t,n){function i(l){l===void 0&&(l=0);var d=t+l>=1?t+l:0;return e.el.getPointAtLength(d)}var r=Ce(e.el,e.svg),s=i(),c=i(-1),o=i(1),a=n?1:r.w/r.vW,v=n?1:r.h/r.vH;switch(e.property){case"x":return(s.x-r.x)*a;case"y":return(s.y-r.y)*v;case"angle":return Math.atan2(o.y-c.y,o.x-c.x)*180/Math.PI}}function fe(e,t){var n=/[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g,i=Le(f.pth(e)?e.totalLength:e,t)+"";return{original:i,numbers:i.match(n)?i.match(n).map(Number):[0],strings:f.str(e)||t?i.split(n):[]}}function se(e){var t=e?$(f.arr(e)?e.map(ue):ue(e)):[];return N(t,function(n,i,r){return r.indexOf(n)===i})}function Pe(e){var t=se(e);return t.map(function(n,i){return{target:n,id:i,total:t.length,transforms:{list:Se(n)}}})}function Ke(e,t){var n=ee(t);if(/^spring/.test(n.easing)&&(n.duration=ye(n.easing)),f.arr(e)){var i=e.length,r=i===2&&!f.obj(e[0]);r?e={value:e}:f.fnc(t.duration)||(n.duration=t.duration/i)}var s=f.arr(e)?e:[e];return s.map(function(c,o){var a=f.obj(c)&&!f.pth(c)?c:{value:c};return f.und(a.delay)&&(a.delay=o?0:t.delay),f.und(a.endDelay)&&(a.endDelay=o===s.length-1?t.endDelay:0),a}).map(function(c){return U(c,n)})}function Xe(e){for(var t=N($(e.map(function(s){return Object.keys(s)})),function(s){return f.key(s)}).reduce(function(s,c){return s.indexOf(c)<0&&s.push(c),s},[]),n={},i=function(s){var c=t[s];n[c]=e.map(function(o){var a={};for(var v in o)f.key(v)?v==c&&(a.value=o[v]):a[v]=o[v];return a})},r=0;r<t.length;r++)i(r);return n}function et(e,t){var n=[],i=t.keyframes;i&&(t=U(Xe(i),t));for(var r in t)f.key(r)&&n.push({name:r,tweens:Ke(t[r],e)});return n}function tt(e,t){var n={};for(var i in e){var r=J(e[i],t);f.arr(r)&&(r=r.map(function(s){return J(s,t)}),r.length===1&&(r=r[0])),n[i]=r}return n.duration=parseFloat(n.duration),n.delay=parseFloat(n.delay),n}function at(e,t){var n;return e.tweens.map(function(i){var r=tt(i,t),s=r.value,c=f.arr(s)?s[1]:s,o=A(c),a=re(t.target,e.name,o,t),v=n?n.to.original:a,l=f.arr(s)?s[0]:v,d=A(l)||A(a),g=o||d;return f.und(c)&&(c=v),r.from=fe(l,g),r.to=fe(ne(c,l),g),r.start=n?n.end:0,r.end=r.start+r.delay+r.duration+r.endDelay,r.easing=K(r.easing,r.duration),r.isPath=f.pth(s),r.isPathTargetInsideSVG=r.isPath&&f.svg(t.target),r.isColor=f.col(r.from.original),r.isColor&&(r.round=1),n=r,r})}var Te={css:function(e,t,n){return e.style[t]=n},attribute:function(e,t,n){return e.setAttribute(t,n)},object:function(e,t,n){return e[t]=n},transform:function(e,t,n,i,r){if(i.list.set(t,n),t===i.last||r){var s="";i.list.forEach(function(c,o){s+=o+"("+c+") "}),e.style.transform=s}}};function Ae(e,t){var n=Pe(e);n.forEach(function(i){for(var r in t){var s=J(t[r],i),c=i.target,o=A(s),a=re(c,r,o,i),v=o||A(a),l=ne(Le(s,v),a),d=ae(c,r);Te[d](c,r,l,i.transforms,!0)}})}function rt(e,t){var n=ae(e.target,t.name);if(n){var i=at(t,e),r=i[i.length-1];return{type:n,property:t.name,animatable:e,tweens:i,duration:r.end,delay:i[0].delay,endDelay:r.endDelay}}}function nt(e,t){return N($(e.map(function(n){return t.map(function(i){return rt(n,i)})})),function(n){return!f.und(n)})}function Ie(e,t){var n=e.length,i=function(s){return s.timelineOffset?s.timelineOffset:0},r={};return r.duration=n?Math.max.apply(Math,e.map(function(s){return i(s)+s.duration})):t.duration,r.delay=n?Math.min.apply(Math,e.map(function(s){return i(s)+s.delay})):t.delay,r.endDelay=n?r.duration-Math.max.apply(Math,e.map(function(s){return i(s)+s.duration-s.endDelay})):t.endDelay,r}var ve=0;function it(e){var t=Q(ge,e),n=Q(G,e),i=et(n,e),r=Pe(e.targets),s=nt(r,i),c=Ie(s,n),o=ve;return ve++,U(t,{id:o,children:[],animatables:r,animations:s,duration:c.duration,delay:c.delay,endDelay:c.endDelay})}var C=[],ke=function(){var e;function t(){!e&&(!me()||!b.suspendWhenDocumentHidden)&&C.length>0&&(e=requestAnimationFrame(n))}function n(r){for(var s=C.length,c=0;c<s;){var o=C[c];o.paused?(C.splice(c,1),s--):(o.tick(r),c++)}e=c>0?requestAnimationFrame(n):void 0}function i(){b.suspendWhenDocumentHidden&&(me()?e=cancelAnimationFrame(e):(C.forEach(function(r){return r._onDocumentVisibility()}),ke()))}return typeof document<"u"&&document.addEventListener("visibilitychange",i),t}();function me(){return!!document&&document.hidden}function b(e){e===void 0&&(e={});var t=0,n=0,i=0,r,s=0,c=null;function o(m){var p=window.Promise&&new Promise(function(E){return c=E});return m.finished=p,p}var a=it(e);o(a);function v(){var m=a.direction;m!=="alternate"&&(a.direction=m!=="normal"?"normal":"reverse"),a.reversed=!a.reversed,r.forEach(function(p){return p.reversed=a.reversed})}function l(m){return a.reversed?a.duration-m:m}function d(){t=0,n=l(a.currentTime)*(1/b.speed)}function g(m,p){p&&p.seek(m-p.timelineOffset)}function w(m){if(a.reversePlayback)for(var E=s;E--;)g(m,r[E]);else for(var p=0;p<s;p++)g(m,r[p])}function h(m){for(var p=0,E=a.animations,I=E.length;p<I;){var S=E[p],k=S.animatable,B=S.tweens,O=B.length-1,L=B[O];O&&(L=N(B,function(De){return m<De.end})[0]||L);for(var z=P(m-L.start-L.delay,0,L.duration)/L.duration,H=isNaN(z)?1:L.easing(z),M=L.to.strings,Y=L.round,W=[],ze=L.to.numbers.length,D=void 0,q=0;q<ze;q++){var F=void 0,oe=L.to.numbers[q],ce=L.from.numbers[q]||0;L.isPath?F=Ge(L.value,H*oe,L.isPathTargetInsideSVG):F=ce+H*(oe-ce),Y&&(L.isColor&&q>2||(F=Math.round(F*Y)/Y)),W.push(F)}var le=M.length;if(!le)D=W[0];else{D=M[0];for(var j=0;j<le;j++){M[j];var de=M[j+1],_=W[j];isNaN(_)||(de?D+=_+de:D+=_+" ")}}Te[S.type](k.target,S.property,D,k.transforms),S.currentValue=D,p++}}function u(m){a[m]&&!a.passThrough&&a[m](a)}function y(){a.remaining&&a.remaining!==!0&&a.remaining--}function x(m){var p=a.duration,E=a.delay,I=p-a.endDelay,S=l(m);a.progress=P(S/p*100,0,100),a.reversePlayback=S<a.currentTime,r&&w(S),!a.began&&a.currentTime>0&&(a.began=!0,u("begin")),!a.loopBegan&&a.currentTime>0&&(a.loopBegan=!0,u("loopBegin")),S<=E&&a.currentTime!==0&&h(0),(S>=I&&a.currentTime!==p||!p)&&h(p),S>E&&S<I?(a.changeBegan||(a.changeBegan=!0,a.changeCompleted=!1,u("changeBegin")),u("change"),h(S)):a.changeBegan&&(a.changeCompleted=!0,a.changeBegan=!1,u("changeComplete")),a.currentTime=P(S,0,p),a.began&&u("update"),m>=p&&(n=0,y(),a.remaining?(t=i,u("loopComplete"),a.loopBegan=!1,a.direction==="alternate"&&v()):(a.paused=!0,a.completed||(a.completed=!0,u("loopComplete"),u("complete"),!a.passThrough&&"Promise"in window&&(c(),o(a)))))}return a.reset=function(){var m=a.direction;a.passThrough=!1,a.currentTime=0,a.progress=0,a.paused=!0,a.began=!1,a.loopBegan=!1,a.changeBegan=!1,a.completed=!1,a.changeCompleted=!1,a.reversePlayback=!1,a.reversed=m==="reverse",a.remaining=a.loop,r=a.children,s=r.length;for(var p=s;p--;)a.children[p].reset();(a.reversed&&a.loop!==!0||m==="alternate"&&a.loop===1)&&a.remaining++,h(a.reversed?a.duration:0)},a._onDocumentVisibility=d,a.set=function(m,p){return Ae(m,p),a},a.tick=function(m){i=m,t||(t=i),x((i+(n-t))*b.speed)},a.seek=function(m){x(l(m))},a.pause=function(){a.paused=!0,d()},a.play=function(){a.paused&&(a.completed&&a.reset(),a.paused=!1,C.push(a),d(),ke())},a.reverse=function(){v(),a.completed=!a.reversed,d()},a.restart=function(){a.reset(),a.play()},a.remove=function(m){var p=se(m);Oe(p,a)},a.reset(),a.autoplay&&a.play(),a}function pe(e,t){for(var n=t.length;n--;)X(e,t[n].animatable.target)&&t.splice(n,1)}function Oe(e,t){var n=t.animations,i=t.children;pe(e,n);for(var r=i.length;r--;){var s=i[r],c=s.animations;pe(e,c),!c.length&&!s.children.length&&i.splice(r,1)}!n.length&&!i.length&&t.pause()}function st(e){for(var t=se(e),n=C.length;n--;){var i=C[n];Oe(t,i)}}function ot(e,t){t===void 0&&(t={});var n=t.direction||"normal",i=t.easing?K(t.easing):null,r=t.grid,s=t.axis,c=t.from||0,o=c==="first",a=c==="center",v=c==="last",l=f.arr(e),d=parseFloat(l?e[0]:e),g=l?parseFloat(e[1]):0,w=A(l?e[1]:e)||0,h=t.start||0+(l?d:0),u=[],y=0;return function(x,m,p){if(o&&(c=0),a&&(c=(p-1)/2),v&&(c=p-1),!u.length){for(var E=0;E<p;E++){if(!r)u.push(Math.abs(c-E));else{var I=a?(r[0]-1)/2:c%r[0],S=a?(r[1]-1)/2:Math.floor(c/r[0]),k=E%r[0],B=Math.floor(E/r[0]),O=I-k,L=S-B,z=Math.sqrt(O*O+L*L);s==="x"&&(z=-O),s==="y"&&(z=-L),u.push(z)}y=Math.max.apply(Math,u)}i&&(u=u.map(function(M){return i(M/y)*y})),n==="reverse"&&(u=u.map(function(M){return s?M<0?M*-1:-M:Math.abs(y-M)}))}var H=l?(g-d)/y:d;return h+H*(Math.round(u[m]*100)/100)+w}}function ct(e){e===void 0&&(e={});var t=b(e);return t.duration=0,t.add=function(n,i){var r=C.indexOf(t),s=t.children;r>-1&&C.splice(r,1);function c(g){g.passThrough=!0}for(var o=0;o<s.length;o++)c(s[o]);var a=U(n,Q(G,e));a.targets=a.targets||e.targets;var v=t.duration;a.autoplay=!1,a.direction=t.direction,a.timelineOffset=f.und(i)?v:ne(i,v),c(t),t.seek(a.timelineOffset);var l=b(a);c(l),s.push(l);var d=Ie(s,e);return t.delay=d.delay,t.endDelay=d.endDelay,t.duration=d.duration,t.seek(0),t.reset(),t.autoplay&&t.play(),t},t}b.version="3.2.1";b.speed=1;b.suspendWhenDocumentHidden=!0;b.running=C;b.remove=st;b.get=re;b.set=Ae;b.convertPx=te;b.path=Je;b.setDashoffset=Ze;b.stagger=ot;b.timeline=ct;b.easing=K;b.penner=be;b.random=function(e,t){return Math.floor(Math.random()*(t-e+1))+e};const lt="https://maicolz04.github.io/SAMA/assets/logo-CTP7jt_G.png",dt="https://maicolz04.github.io/SAMA/assets/avatar-CihuUeZi.png";document.querySelector(".logo img").src=lt;document.querySelector(".hero-image img").src=dt;document.addEventListener("DOMContentLoaded",()=>{document.querySelector("#app").innerHTML=`
  <header class="header">
        <div class="logo">
